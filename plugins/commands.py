...
HELP = """🏷️ **Need Help?** 🤔
__(Join @NET_HACKER_BOTs_chat For Support)__
...
async def start(client, message):
    buttons = [
        ...
        InlineKeyboardButton('SUPPORT', url='https://t.me/NET_HACKER_BOTs_chat'),
    ],
    [
        InlineKeyboardButton('MORE BOTS', url='https://t.me/NET_HACKER_BOTs/21'),
